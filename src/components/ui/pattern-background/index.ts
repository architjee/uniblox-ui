  ...
  variants: {
    variant: {
      ...
      [PATTERN_BACKGROUND_VARIANT.BigDot]:
        'bg-[radial-gradient(var(--foreground)_3px,transparent_3px)]',
    },
    size: {
      xs: 'bg-[size:8px_8px]',
...
export const patternBackgroundMaskVariants = cva('bg-background', {
  variants: {
    mask: {
      ...
      [PATTERN_BACKGROUND_MASK.FullCover]:
        '[mask-image:radial-gradient(ellipse_at_center,transparent,black_99%)]',
    },
  },
  defaultVariants: {
    mask: 'ellipse',
